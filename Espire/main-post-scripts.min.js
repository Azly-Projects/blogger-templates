        ...
        ? $.ajax({
            ...
            success: function (e) {
              for (
                ...
                else if ("summary" in b_rc) l = e.feed.entry[r].summary.$t;
                else l = "";
                ...
                var d = e.feed.entry[r].title.$t,
                  ...
                  m = p.substring(5, 7),
                  h = p.substring(8, 10),
                  u = month_format[parseInt(m, 10)] + " " + h + ", " + f,
                  y = e.feed.entry[r].content.$t,
                  g = $("<div>").html(y);
                if (y.indexOf("//www.youtube.com/embed/") > -1)
                  i = e.feed.entry[r].media$thumbnail.url;
                else if (y.indexOf("<img") > -1)
                  i = g.find("img:first").attr("src");
                else i = no_image;
                a +=
                  0 == r
      ...
      $.ajax({
        ...
        success: function (t) {
          for (
            ...
            else if ("summary" in b_rc) o = t.feed.entry[n].summary.$t;
            else o = "";
            ...
            var c = t.feed.entry[n].title.$t,
              ...
              v = $("<div>").html(b);
            if (b.indexOf("//www.youtube.com/embed/") > -1)
              d = t.feed.entry[n].media$thumbnail.url;
            else if (b.indexOf("<img") > -1)
              d = v.find("img:first").attr("src");
            else d = no_image;
            s +=
              0 == n
    ...
    $.ajax({
      ...
      success: function (t) {
        for (
          ...
          else if (d.match("http://img2.blogblog.com/img/b16-rounded.gif"))
            o = "http://img1.blogblog.com/img/anon36.png";
          else o = d;
          r +=
      ...
      success: function (t) {
        for (
          ...
          var i = t.feed.entry[s].title.$t,
            ...
            c = d.substring(5, 7),
            p = d.substring(8, 10),
            f = month_format[parseInt(c, 10)] + " " + p + ", " + o,
            m = t.feed.entry[s].content.$t,
            h = $("<div>").html(m);
          if (m.indexOf("//www.youtube.com/embed/") > -1)
            var u = t.feed.entry[s].media$thumbnail.url.replace(
              "/default.jpg",
              "/mqdefault.jpg"
            );
          else if (m.indexOf("<img") > -1)
            u = h.find("img:first").attr("src").replace("s72-c", "s1600");
          else u = no_image;
          r +=
          ...
          success: function (a) {
            for (
              ...
              var l = a.feed.entry[n].title.$t,
                ...
                f = c.substring(5, 7),
                m = c.substring(8, 10),
                h = month_format[parseInt(f, 10)] + " " + m + ", " + p,
